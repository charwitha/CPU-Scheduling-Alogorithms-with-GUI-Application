...
class fcfs extends Exception implements ActionListener
{
...
Label h1=new Label("First Come First Serve Scheduling Algorithm");
Label n1=new Label("First Come First Serve Output");
...
Frame max=new Frame();
Frame next= new Frame("First Come First Serve Output");
...
Color c2=new Color(240,128,128);
...
Font font5 = new Font( "Comic Sans MS", Font.ITALIC, 12 );
  ...
  {
   max.setSize(650,650);
   max.setTitle("First Come First Serve Scheduling Algorithm");
   x.setSize(650,650);
...
Label n8=new Label("Avg. Turnaround time:      "+str8);
Label n9=new Label("Throughput:          "+str9);

n1.setForeground(Color.magenta);
